...
The production baseline is `3e5ae71` on `main`, which includes the committed Phase 2A information architecture, Phase 2B release-date pilot, Phase 2C-A system-requirements pilot, Phase 2C-B Phantom Edges explainer, Phase 2C-C combat-system overview, Phase 2C-D Weapons Hub, and Phase 2C-E Characters Hub + Soul. The current checkout is `/home/mok/projects/pbzguides` on `content/bosses-seven-stars`; Phase 2C-F changes are intentionally uncommitted. The remote is `https://github.com/kelewutang/pbzguides.git`.
...
- `npm run build`: passed. Final output: 13 HTML pages: `/`, `/404`, `/guides/`, `/guides/phantom-blade-zero-release-date/`, `/guides/phantom-blade-zero-system-requirements/`, `/weapons/`, `/weapons/phantom-edges/`, `/combat/`, `/combat/combat-system/`, `/characters/`, `/characters/soul/`, `/bosses/` and `/bosses/seven-stars/`; `/robots.txt` and `/sitemap.xml` are also generated. The sitemap contains 12 canonical indexable URLs: `/`, `/guides/`, `/guides/phantom-blade-zero-release-date/`, `/guides/phantom-blade-zero-system-requirements/`, `/weapons/`, `/weapons/phantom-edges/`, `/combat/`, `/combat/combat-system/`, `/characters/`, `/characters/soul/`, `/bosses/` and `/bosses/seven-stars/`. The 404 page remains excluded. The verifier checked language, H1, metadata, canonicals, JSON-LD, internal links, robots, 404 exclusion, no runtime scripts and per-area published-route projection.
